    ...
    public sealed class DisplayAttribute : Attribute
    {
        ...
        public bool AutoGenerateField
        {
            get
            {
                ...
                {
                    throw new InvalidOperationException(String.Format(CultureInfo.CurrentCulture, "PropertyNotSet", "AutoGenerateField", "GetAutoGenerateField"));
                }
        ...
        public bool AutoGenerateFilter
        {
            get
            {
                ...
                {
                    throw new InvalidOperationException(String.Format(CultureInfo.CurrentCulture, "PropertyNotSet", "AutoGenerateFilter", "GetAutoGenerateFilter"));
                }
        ...
        public int Order
        {
            get
            {
                ...
                {
                    throw new InvalidOperationException(String.Format(CultureInfo.CurrentCulture, "PropertyNotSet", "Order", "GetOrder"));
                }
