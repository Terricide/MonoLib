...
namespace System.IO
{
    ...
    public class UnmanagedMemoryAccessor : IDisposable
    {
        ...
        protected void Initialize(SafeBuffer buffer, Int64 offset, Int64 capacity, FileAccess access)
        {
            ...
            if (capacity < 0)
            {
                throw new ArgumentOutOfRangeException("capacity", EnvironmentEx.GetResourceString("ArgumentOutOfRange_NeedNonNegNum"));
            }
            if (buffer.ByteLength < (UInt64)(offset + capacity))
            {
                throw new ArgumentException(EnvironmentEx.GetResourceString("Argument_OffsetAndCapacityOutOfBounds"));
            }
            ...
            unsafe
            {
                ...
                try
                {
                    ...
                    {
                        throw new ArgumentException(EnvironmentEx.GetResourceString("Argument_UnmanagedMemAccessorWrapAround"));
                    }
                }
                finally
                {
        ...
        public void Read<T>(Int64 position, out T structure) where T : struct
        {
            if (position < 0)
            {
                throw new ArgumentOutOfRangeException("position", EnvironmentEx.GetResourceString("ArgumentOutOfRange_NeedNonNegNum"));
            }
            Contract.EndContractBlock();

            if (!_isOpen)
            {
                throw new ObjectDisposedException("UnmanagedMemoryAccessor", EnvironmentEx.GetResourceString("ObjectDisposed_ViewAccessorClosed"));
            }
            if (!CanRead)
            {
                throw new NotSupportedException(EnvironmentEx.GetResourceString("NotSupported_Reading"));
            }

            UInt32 sizeOfT = MarshalEx.SizeOfType(typeof(T));
            if (position > _capacity - sizeOfT)
            {
                if (position >= _capacity)
                {
                    throw new ArgumentOutOfRangeException("position", EnvironmentEx.GetResourceString("ArgumentOutOfRange_PositionLessThanCapacityRequired"));
                }
                else
                {
                    throw new ArgumentException(EnvironmentEx.GetResourceString("Argument_NotEnoughBytesToRead", typeof(T).FullName), "position");
                }
            }
        ...
        public int ReadArray<T>(Int64 position, T[] array, Int32 offset, Int32 count) where T : struct
        {
            ...
            {
                throw new ArgumentException(EnvironmentEx.GetResourceString("Argument_OffsetAndLengthOutOfBounds"));
            }
            Contract.EndContractBlock();
            if (!CanRead)
            {
            ...
            UInt32 sizeOfT = MarshalEx.AlignedSizeOf<T>();
        ...
        public void Write(Int64 position, Decimal value)
        {
            ...
            DecimalEx.GetBytes(value, decimalArray);
        ...
        public void Write<T>(Int64 position, ref T structure) where T : struct
        {
            ...
            if (!CanWrite)
            {
                throw new NotSupportedException(EnvironmentEx.GetResourceString("NotSupported_Writing"));
            }
            ...
            if (position > _capacity - sizeOfT)
            {
                ...
                {
                    throw new ArgumentException(EnvironmentEx.GetResourceString("Argument_NotEnoughBytesToWrite", typeof(T).FullName), "position");
                }
            }
        ...
        private void EnsureSafeToRead(Int64 position, int sizeOfType)
        {
            ...
            if (position > _capacity - sizeOfType)
            {
                ...
                {
                    throw new ArgumentException(EnvironmentEx.GetResourceString("Argument_NotEnoughBytesToRead"), "position");
                }
            }
        }
        ...
        private void EnsureSafeToWrite(Int64 position, int sizeOfType)
        {
            ...
            if (position > _capacity - sizeOfType)
            {
                ...
                {
                    throw new ArgumentException(EnvironmentEx.GetResourceString("Argument_NotEnoughBytesToWrite", "Byte"), "position");
                }
            }
        }
